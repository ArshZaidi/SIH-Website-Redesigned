import { Sparkles, Globe, Lightbulb, Rocket, TrendingUp, Award, ArrowRight } from 'lucide-react'

const POINTS = [
  {
    icon: Globe,
    title: 'World&rsquo;s largest open innovation model',
  ...
  {
    icon: Lightbulb,
    title: 'From classrooms to real-world impact',
  ...
  {
    icon: Rocket,
    title: 'A pipeline for startups and incubation',
  ...
  },
  {
    ...
    desc: 'SIH themes — AI, clean energy, medtech, agriculture, cybersecurity, space tech and digital public services — directly support India&rsquo;s vision of a self-reliant, innovative nation.',
  },
  {
    icon: Award,
    title: 'National recognition and rewards',
