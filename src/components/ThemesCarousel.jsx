...
export default function ThemesCarousel({ activeTheme, onPick }) {
  ...
  /* responsive per-view calculation */
  useEffect(() => {
    const compute = () => {
  ...
  return (
    ...
    >
      ...
      <div className="tc-controls">
        <button className="tc-nav" onClick={prev} aria-label="Previous themes">
          <ChevronLeft size={18} />
        </button>
        ...
        <button className="tc-nav" onClick={next} aria-label="Next themes">
