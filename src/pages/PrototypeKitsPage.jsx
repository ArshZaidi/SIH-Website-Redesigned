...
import {
  ArrowLeft, Search, X, ExternalLink, Code2, Database, Cpu, Layers, Filter,
} from 'lucide-react'

/* Inline GitHub icon — lucide-react dropped brand icons in v0.460+ */
...
export default function PrototypeKitsPage({ onBack }) {
  ...
  const reset = () => {
    setQuery(''); setThemeFilter('All'); setTypeFilter('All')
  }
  ...
  return (
    <div className="doc-page">
      <div className="doc-topbar">
        ...
        <h1>Prototype Starter Kits</h1>
        <span className="pp-count mono">{filtered.length} / {KITS.length}</span>
      </div>
      ...
      <div className="container">
        <section className="doc-hero">
          ...
          <p>
            A curated list of open-source tools, public datasets and free-tier
            APIs that teams can use to go from idea to working prototype faster.
            Everything here is free for students or has a student tier.
          </p>
        </section>
        ...
        <div className="doc-cta">
          <h3>Can&rsquo;t find your theme?</h3>
          <p>Browse the SIH portal for problem statements — most kits map to a specific ministry.</p>
