...
import {
  ArrowLeft, Sparkles, Cpu, TrendingUp, Rocket, Users, MessageSquare,
...
export default function EvaluationRubricPage({ onBack }) {
  ...
  return (
    <div className="doc-page">
      <div className="doc-topbar">
        ...
        <span className="pp-count mono">6 criteria</span>
      </div>
      ...
      <div className="container">
        <section className="doc-hero">
          ...
          <p>
            Every submission at SIH is scored against six weighted criteria.
            Understanding the weights is the single biggest lever you have for
            improving your final score — teams often spend 40% of their effort
            on criteria worth 15%.
          </p>
              ...
              return (
                <div className="rubric-weight" key={c.title}>
                  ...
                  <div className="rw-bar">
                    <div className="rw-bar-fill" style={{ width: `${c.weight * 5}%` }} />
                  </div>
                </div>
              )
            })}
        ...
        <section className="doc-block">
          <h2 className="doc-block-title">
            ...
            Idea phase vs grand finale
          </h2>
          <div className="rubric-compare">
            <div className="rubric-compare-card">
              <h4>Idea Phase</h4>
              <p>
                The five-slide deck is scored on <strong>Innovation</strong>,{' '}
                <strong>Feasibility</strong> and <strong>Relevance</strong>.
                Execution quality is not evaluated — you have not built anything yet.
              </p>
            </div>
            <div className="rubric-compare-card">
              <h4>Grand Finale</h4>
              <p>
                All six criteria apply. <strong>Execution Quality</strong> carries
                a meaningful weight — a strong idea with a broken demo will lose to
                a simpler idea with a working prototype.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="doc-cta">
          <h3>Score higher on every criterion</h3>
          <p>Read the idea template to see how each criterion maps to a slide.</p>
