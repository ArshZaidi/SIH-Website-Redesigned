...
import {
  ArrowLeft, Calendar, Clock, Users, Check, BookOpen, Video,
...
export default function MentorOfficeHoursPage({ onBack }) {
  ...
  return (
    <div className="doc-page">
      <div className="doc-topbar">
        ...
        <h1>Mentor Office Hours</h1>
        <span className="pp-count mono">{SLOTS.filter((s) => !s.full).length} slots open</span>
      </div>
      ...
      <div className="container">
        <section className="doc-hero">
          ...
          <p>
            Every shortlisted team gets access to domain experts appointed by the
            sponsoring ministry. Sessions run twice a week during the idea phase
            and daily during the grand finale.
          </p>
        ...
        <section className="doc-block">
          ...
          {picked && (
            <div className="slot-confirm">
              <Check size={16} />
              <span>
                You picked <strong>{picked}</strong>. In the live SIH portal, confirming
                would now send a Google Calendar invite and the meeting link.
              </span>
            </div>
          )}
        </section>
          ...
          <div className="prep-layout">
            <div className="prep-list">
              ...
              <ul className="doc-checklist">
                {PREP.map((p) => (
                  <li key={p}><Check size={15} /> <span>{p}</span></li>
                ))}
              </ul>
            </div>
            <div className="prep-aside">
              <div className="prep-note">
                <AlertCircle size={16} />
                <div>
                  <strong>No-shows are tracked</strong>
                  <p>Teams that miss two booked sessions without notice lose priority booking for the rest of the phase.</p>
                </div>
              </div>
              <div className="prep-note">
                ...
                <div>
                  ...
                  <p>"Should we use ML or rules?" gets a useful answer. "Is our idea good?" does not.</p>
                </div>
              </div>
              <div className="prep-note">
                <BookOpen size={16} />
                <div>
                  <strong>Record with permission</strong>
                  <p>Mentors usually allow recording — ask at the start. Written notes work too.</p>
                </div>
              </div>
              <div className="prep-note">
                <Award size={16} />
                <div>
                  <strong>Mentors can champion you</strong>
                  <p>Mentors do not judge, but they do brief the jury. Strong sessions matter.</p>
                </div>
              </div>
            </div>
          </div>
