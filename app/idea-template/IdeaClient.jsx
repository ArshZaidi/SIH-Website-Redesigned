...
import {
  BookOpen, Target, Cpu, TrendingUp, Users, Check, AlertCircle,
  Lightbulb, FileText, Layout,
} from 'lucide-react'
import PageTopBar from '../components/ui/PageTopBar'

const SLIDES = [
  { n: '01', icon: Target, title: 'Problem Understanding',
  ...
  { n: '02', icon: Lightbulb, title: 'Proposed Solution',
  ...
  { n: '03', icon: Cpu, title: 'Technical Approach',
    ...
    tip: 'Name specific libraries and services. "We will use React + Node.js + PostgreSQL on AWS" beats "we will use a modern tech stack".' },
  { n: '04', icon: TrendingUp, title: 'Feasibility & Impact',
    ...
    tip: 'The best submissions separate "finale prototype" from "deployable product". Judges know you cannot build a production system in 36 hours.' },
  { n: '05', icon: Users, title: 'Team & Execution Plan',
    ...
    tip: 'Do not list all six members as "full-stack developers". Show role clarity.' },
]
...
export default function IdeaClient() {
  return (
    <div className="doc-page">
      <PageTopBar title="Idea Submission Template" count="5 slides" className="doc-topbar" />

      <div className="container">
        <section className="doc-hero">
          <span className="kicker mono">// Resource</span>
          <h1>The five-slide deck the jury expects</h1>
          <p>Every idea submission at SIH is judged on a five-slide deck. This is the exact structure that has worked across nine editions — what each slide should contain, and what to leave out.</p>
        ...
        <section className="doc-block">
          <h2 className="doc-block-title"><span className="kicker mono">01</span> Slide-by-slide breakdown</h2>
              ...
              return (
                <article className="doc-slide" key={s.n} style={{ animationDelay: `${i * 60}ms` }}>
                  ...
                  <ul className="doc-checklist">
                    {s.include.map((x) => <li key={x}><Check size={15} /> <span>{x}</span></li>)}
                  </ul>
                  <div className="doc-tip"><Lightbulb size={15} /><p>{s.tip}</p></div>
                </article>
              )
            })}
          </div>
        ...
        <section className="doc-block">
          <h2 className="doc-block-title"><span className="kicker mono">02</span> Common mistakes to avoid</h2>
        ...
        <section className="doc-block">
          <h2 className="doc-block-title"><span className="kicker mono">03</span> Pre-submission checklist</h2>
