...
import {
  Rocket, ShieldCheck, Users, IndianRupee, Award, FileCheck, Scale,
} from 'lucide-react'
import PageTopBar from '../components/ui/PageTopBar'

const GUIDELINES = [
  { icon: Rocket, title: 'Feasibility before deployment',
  ...
  { icon: FileCheck, title: 'Development duration',
  ...
  { icon: Users, title: 'Initiate communication',
  ...
  { icon: FileCheck, title: 'Detailed project plan',
  ...
  { icon: Rocket, title: 'Procurement of critical tools',
  ...
  { icon: Users, title: 'Coordination agency',
  ...
  { icon: Users, title: 'Assign a technical mentor',
  ...
  { icon: Users, title: 'Regular monitoring sessions',
  ...
  { icon: Users, title: 'Faculty co-mentor',
  ...
  { icon: FileCheck, title: 'Institutional consent',
  ...
  { icon: IndianRupee, title: 'Site visits',
  ...
  { icon: ShieldCheck, title: 'Cybersecurity expert',
  ...
  { icon: ShieldCheck, title: 'Product design expert',
  ...
  { icon: IndianRupee, title: 'Stipend & internship',
  ...
  { icon: FileCheck, title: 'Quarterly status reports',
...
const TRAVEL = [
  { label: 'Long Distance Travel', detail: 'Each student is entitled to AC-III tier train ticket fare. The amount is reimbursed on producing the tickets.' },
  { label: 'Short Distance Travel', detail: 'Each student is entitled to \u20B91,000 per day for short-distance travel (within a 100 km radius of the college). Bills and receipts must be produced.' },
  { label: 'Stay', detail: 'Each student is entitled to \u20B91,500 per day for long-distance travel, reimbursed on producing valid bills and receipts.' },
  { label: 'Field Visit Allowance', detail: 'For costs incurred during field visits (data collection, user testing), each person is entitled to \u20B9500 per day. Prior approval must be taken from the ministry or department.' },
]

export default function ImplClient() {
  return (
    <div className="pi-page">
      <PageTopBar title="Project Implementation" className="pi-topbar" />

      <div className="container">
        <section className="pi-hero">
          <span className="kicker mono">// Deployment Guidelines</span>
          <h1>From winning prototype to deployed solution</h1>
          <p>The Smart India Hackathon is envisioned to promote innovation and out-of-the-box thinking among young minds. Post SIH, the Ministry of Education is committed to further development, implementation and deployment of SIH-winning ideas.</p>
          <p>These guidelines outline the process that a sponsoring ministry or department is requested to follow when taking a winning prototype from the final stage to a field-ready solution.</p>
        </section>
              ...
              return (
                <article className="pi-card" key={g.title} style={{ animationDelay: `${i * 40}ms` }}>
                  ...
                  <div className="pi-card-body">
                    <span className="mono pi-card-num">{String(i + 1).padStart(2, '0')}</span>
                    <h3>{g.title}</h3>
                    <p>{g.body}</p>
                  </div>
                </article>
        ...
        <section className="pi-highlight">
          ...
          <div>
            ...
            <p>Each team member can receive <strong>\u20B910,000\u2013\u20B915,000 per month</strong> for a minimum of 6 months during development and implementation. A maximum of 6 students per team are eligible for this stipend.</p>
          </div>
        </section>
        ...
        <section className="pi-ip">
          ...
          <p className="pi-ip-lead">The Intellectual Property (IP) of the solution resides with the students who have developed and deployed the solution post-hackathon, but the concerned ministry will have <strong>lifetime access</strong> to the solution for free.</p>
          <p>This has been done to encourage startups to be created out of the developed solutions, while also keeping in mind the interest of the involved ministries.</p>
          <div className="pi-ip-notes">
            <div className="pi-note"><Award size={16} /><p>If a ministry IT or domain expert becomes a major contributor, they may be considered a co-contributor in the IP after due consultation.</p></div>
            <div className="pi-note"><ShieldCheck size={16} /><p>Teams must use only verified open-source components and acknowledge them. Any conflict from plagiarism, IP or copyright violations is solely the responsibility of the concerned team members.</p></div>
            <div className="pi-note"><Users size={16} /><p>If team members pass out or leave, the team has the flexibility to include new members as replacements to continue development and deployment.</p></div>
          </div>
        </section>
      </div>
    </div>
